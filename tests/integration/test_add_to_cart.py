...
def test_add_to_cart_success():
    ...
    response = make_post_request(ADD_TO_CART_ENDPOINT.format(user_id), payload, params={})
...
def test_clear_cart_success():
    ...
    add_response = make_post_request(ADD_TO_CART_ENDPOINT.format(user_id), payload, params={})
